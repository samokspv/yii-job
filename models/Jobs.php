...
class Jobs extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('job_class, job_status_id', 'required'),
            array('job_status_id', 'numerical', 'integerOnly' => true),
            array('job_class', 'length', 'max' => 64),
            array('crontab', 'length', 'max' => 128),
            array('job_data, planned_time, start_time, finish_time, create_time, update_time', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, job_class, job_data, crontab, planned_time, start_time, finish_time, job_status_id, create_time, update_time', 'safe', 'on' => 'search'),
        );
    }
